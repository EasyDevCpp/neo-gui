...
public:
	Button(Widget *wid,int x,int y,int w,int h,Style s,Renderer *r) {
		widget=wid;
		setX(x);
		setY(y);
		setWidth(w);
	...
	Button(Widget *wid,int x,int y,int w,Style s,Renderer *r) {
		widget=wid;
		setX(x);
		setY(y);
		setWidth(w);
	...
	Button(Widget *wid,int x,int y,Style s,Renderer *r) {
		widget=wid;
		setX(x);
		setY(y);
	...
	Button(int x,int y,int w,int h,Style s,Renderer *r) {
		widget=nullptr;
		setX(x);
		setY(y);
		setWidth(w);
